      ...
      <div className="row row-cols-lg-4 row-cols-md-3 row-cols-sm-2 m-0 gy-5">
        <div>
          ...
          <div className='d-flex gap-4 justify-content-center mt-2'>
            <a><i className="text-white fa-brands fa-facebook-f"></i></a>
            <a><i className="text-white fa-brands fa-twitter"></i></a>
            <a><i className="text-white fa-brands fa-linkedin"></i></a>
            <a><i className="text-white fa-brands fa-youtube"></i></a>
          </div>
        </div>  
        <div>
