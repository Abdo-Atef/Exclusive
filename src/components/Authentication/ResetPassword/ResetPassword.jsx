      ...
      <div className="col-md-5 shadow px-4 py-5">
        <form onSubmit={formik.handleSubmit}>
          ...
          <div>
            ...
            <input onChange={formik.handleChange} onBlur={formik.handleBlur} value={formik.values.newPassword} id='newPassword' name='newPassword' type="password" className='border-0 secondry1 px-2 rounded-1 sign_in_out_inputs' />
